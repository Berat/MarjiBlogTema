...
function optionsframework_add_admin() {
    ...
    $of_page = add_menu_page($themename, 'BeratBlog', 'edit_theme_options', 'optionsframework','optionsframework_options_page', get_bloginfo('template_url').'/admin/images/panel.png'); // Default
